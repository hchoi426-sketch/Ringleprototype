...
import svgPaths from "../../imports/svg-ccgji30hbv";
  ...
  return (
    <div className="relative size-full" style={{ backgroundImage: "linear-gradient(90deg, rgb(244, 248, 255) 0%, rgb(244, 248, 255) 100%), linear-gradient(90deg, rgb(252, 252, 255) 0%, rgb(252, 252, 255) 100%)" }}>
      ...
      <div className="absolute bg-white content-stretch flex flex-col h-[300px] items-center justify-center left-[20px] rounded-[24px] top-[315px] w-[353px]">
        ...
        <div className="content-stretch flex flex-col gap-[62px] h-[248px] items-center relative shrink-0">
          ...
          <div className="content-stretch flex flex-col gap-[16px] items-center not-italic relative shrink-0 text-center whitespace-nowrap">
            <p className="font-['Pretendard:SemiBold',sans-serif] leading-[39px] relative shrink-0 text-[#7a5de8] text-[24px] tracking-[0.0703px]">What if we add a filter?</p>
            <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] relative shrink-0 text-[#999] text-[14px] tracking-[-0.1504px]">필터를 추가해보면 어떨까요?</p>
          </div>
        </div>
      </div>

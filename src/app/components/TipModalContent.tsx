...
import svgPaths from "../../imports/svg-jdvvbwyisx";

type ContainerBackgroundImage1Props = {
  text: string;
};

function ContainerBackgroundImage1({ text }: ContainerBackgroundImage1Props) {
  return (
...
function BackgroundImage2({ children, additionalClassNames = "", onClick }: React.PropsWithChildren<BackgroundImage2Props>) {
  return (
    <div className={clsx("relative rounded-[17722700px] shrink-0", additionalClassNames)} onClick={onClick}>
...
interface TipModalContentProps {
  onClose: () => void;
}

export default function TipModalContent({ onClose }: TipModalContentProps) {
  return (
      ...
      <div className="bg-white h-[71.989px] relative rounded-tl-[24px] rounded-tr-[24px] shrink-0 w-full" data-name="LearningTipModal">
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center justify-between pb-[0.6px] px-[20px] relative size-full">
            ...
            <BackgroundImage2 additionalClassNames="size-[31.996px] cursor-pointer" onClick={onClose}>

...
import svgPaths from "./svg-zof0m5ndfa";
...
function ButtonBackgroundImage1({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative rounded-[10px] shrink-0 size-[35.999px]">
  ...
  return (
    <div className="h-[36px] relative shrink-0 w-[81px]">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <div style={{ backgroundImage: "linear-gradient(-41.2785deg, rgb(105, 50, 194) 16.229%, rgb(143, 114, 255) 83.771%), linear-gradient(90deg, rgb(240, 177, 0) 0%, rgb(255, 105, 0) 100%)" }} className="h-[35.999px] relative rounded-[8px] shrink-0 w-[80.422px]">
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="영어 문장 암기 앱" style={{ backgroundImage: "linear-gradient(112.82deg, rgb(249, 247, 255) 0%, rgb(216, 205, 255) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="absolute h-[1123px] left-0 top-0 w-[393px]" data-name="div">
        <div className="absolute h-0 left-0 top-0 w-[393.022px]" data-name="Section" />
        <div className="-translate-x-1/2 absolute h-[922.64px] left-[calc(50%+0.01px)] top-[104px] w-[361.023px]" data-name="Container">
          <div className="absolute content-stretch flex h-[51.999px] items-center justify-between left-0 top-0 w-[361.023px]" data-name="Container">
          ...
          <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-0 top-[68px] w-[361.023px]">
      ...
      <div className="absolute bg-white content-stretch flex flex-col h-[87.998px] items-start left-0 pt-[18px] px-[16px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] top-0 w-[393.022px]" data-name="div">

...
import svgPaths from "./svg-vvqlhwbfwd";
type IPhone1644BackgroundImageProps = {
  additionalClassNames?: string;
};

function IPhone1644BackgroundImage({ children, additionalClassNames = "" }: React.PropsWithChildren<IPhone1644BackgroundImageProps>) {
  return (
...
export default function IPhone() {
  return (
    <div className="relative size-full" data-name="iPhone 16 - 44" style={{ backgroundImage: "linear-gradient(90deg, rgb(244, 248, 255) 0%, rgb(244, 248, 255) 100%), linear-gradient(90deg, rgb(252, 252, 255) 0%, rgb(252, 252, 255) 100%)" }}>
      <IPhone1644BackgroundImage additionalClassNames="h-[661px] top-[81px]">
      ...
      </IPhone1644BackgroundImage>
      <IPhone1644BackgroundImage additionalClassNames="h-[587px] top-[264px]">

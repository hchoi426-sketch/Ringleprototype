...
import svgPaths from "./svg-m6sysrsmsx";
...
export default function Ai() {
  return (
    <div className="relative size-full" data-name="AI 학습 - 1단계 / 카드뒷면" style={{ backgroundImage: "linear-gradient(90deg, rgb(244, 248, 255) 0%, rgb(244, 248, 255) 100%), linear-gradient(90deg, rgb(252, 252, 255) 0%, rgb(252, 252, 255) 100%)" }}>
      ...
      <div className="absolute content-stretch flex flex-col gap-[16px] h-[300px] items-center justify-center left-[20px] rounded-[24px] top-[314px] w-[353px]" style={{ backgroundImage: "linear-gradient(-59.0362deg, rgb(80, 50, 194) 16.229%, rgb(143, 114, 255) 83.771%)" }}>

import svgPaths from "./svg-6puxz6scdj";
import imgRectangle from "figma:asset/86341c7bede83b7cbe181f624568ab9e63463b5d.png";

export default function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-end py-[16px] relative rounded-[20px] size-full" style={{ backgroundImage: "linear-gradient(-51.9325deg, rgb(105, 50, 194) 16.229%, rgb(143, 114, 255) 83.771%)" }}>

...
import svgPaths from "./svg-hvziv0imkc";
...
function BackgroundImage12({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative shrink-0 size-[66.977px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 66.9771 66.9771">
        {children}
      </svg>
    </div>
  );
...
type AiEVectorBackgroundImageProps = {
  additionalClassNames?: string;
};

function AiEVectorBackgroundImage({ additionalClassNames = "" }: AiEVectorBackgroundImageProps) {
  return (
    <div className={clsx("absolute", additionalClassNames)}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 8.16791">
        <path d={svgPaths.p26915bc0} fill="var(--fill-0, #EDCCF8)" id="Vector" />
      </svg>
    </div>
  );
}
...
function BackgroundImageAndText5({ text, additionalClassNames = "" }: BackgroundImageAndText5Props) {
  return (
    <div className={clsx("-translate-x-1/2 absolute content-stretch flex h-[48px] items-center justify-center px-[10px] py-[16px] rounded-[8px] top-[745px] w-[158px]", additionalClassNames)}>
      <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.24px] whitespace-nowrap">{text}</p>
    </div>
  );
}
...
export default function AiE() {
  return (
    <div className="bg-gradient-to-b from-[#efefff] from-[3.988%] relative size-full to-[#e3e4ff] to-[13.438%]" data-name="AI 튜터-기록 (E-표현 학습)">
      <div className="absolute bg-white h-[1759px] left-0 rounded-tl-[24px] rounded-tr-[24px] top-[216px] w-[393px]" data-name="8017" />
      <div className="absolute contents left-[-1px] top-0">
        <div className="absolute content-stretch flex flex-col gap-[15px] items-start left-[21px] top-[1165px] w-[353px]">
          ...
          <div className="bg-[#eff1f9] min-w-[112px] relative rounded-[8px] shrink-0 w-[353px]" data-name="Container">
            <div className="content-stretch flex items-center justify-between min-w-[inherit] overflow-clip px-[18px] py-[16px] relative rounded-[inherit] w-full">
              <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-[194px]">
                <BackgroundImage9 additionalClassNames="shrink-0">
                  <g id="ion:bulb-outline">
                    <path d={svgPaths.p2ecbdc80} id="Vector" stroke="var(--stroke-0, #9D89EA)" strokeLinecap="round" strokeLinejoin="round" />
                    <path d={svgPaths.p336de918} id="Vector_2" stroke="var(--stroke-0, #9D89EA)" strokeLinecap="round" strokeLinejoin="round" />
                  </g>
                </BackgroundImage9>
                <p className="font-['Pretendard_Variable:Medium',sans-serif] leading-[1.43] not-italic relative shrink-0 text-[#7a5de8] text-[14px] whitespace-nowrap">Ringle’s Tip</p>
              </div>
              <div className="flex items-center justify-center relative shrink-0">
                <div className="-scale-y-100 flex-none rotate-180">
                  <ChevronLeftBackgroundImage>
        ...
        <div className="absolute content-stretch flex gap-[7px] items-start left-0 pb-[8px] px-[36px] top-[104px] w-[393px]">
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-center min-h-px min-w-px opacity-50 relative">
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
              <div className="col-1 ml-0 mt-0 relative row-1 size-[65.97px]">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 65.9697 65.9697">
                  <circle cx="32.9848" cy="32.9848" fill="var(--fill-0, white)" id="Ellipse 644" r="32.9848" />
                </svg>
              </div>
              <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[13.97px] mt-[13.98px] place-items-start relative row-1">
                <div className="col-1 ml-0 mt-0 overflow-clip relative row-1 size-[38px]" data-name="📖 펼쳐진 책">
                  <div className="absolute inset-[13.88%_6.46%]" data-name="Group">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 33.0914 27.455">
                      <g id="Group">
                        <path d={svgPaths.p3635cfb0} fill="var(--fill-0, #7A5DE8)" id="Vector" />
                        <path d={svgPaths.pa856098} fill="var(--fill-0, #DDE3EC)" id="Vector_2" />
                        <path d={svgPaths.p1849260} fill="var(--fill-0, white)" id="Vector_3" />
                      </g>
                    </svg>
                  </div>
                  <div className="absolute flex inset-0 items-center justify-center">
                    <div className="-rotate-90 flex-none size-[38px]">
                  ...
                  <p className="absolute font-['Google_Sans:Bold',sans-serif] inset-[21.05%_57.89%_34.21%_18.42%] leading-[1.4] not-italic text-[#9a85e8] text-[12px] tracking-[-0.24px] whitespace-nowrap">A</p>
                  <p className="absolute font-['Google_Sans:Bold',sans-serif] inset-[13.16%_15.79%_34.21%_60.53%] leading-[1.4] not-italic text-[#533bac] text-[14px] tracking-[-0.24px] whitespace-nowrap">a</p>
                </div>
              </div>
            </div>
            <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[12px] text-[rgba(17,17,17,0.5)] tracking-[-0.24px] whitespace-nowrap">표현 학습</p>
          </div>
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-center min-h-px min-w-px opacity-50 relative">
            <BackgroundImage12>
              <g id="Group 48098815">
                <circle cx="33.4886" cy="33.4886" fill="var(--fill-0, white)" id="Ellipse 644" r="33.4886" />
                <g clipPath="url(#clip0_2_1121)" id="ð¬ ë§íì">
                  <g id="Group">
                    <path d={svgPaths.p39520180} fill="url(#paint0_linear_2_1121)" id="Vector" />
                    <g id="Group_2">
                      <path d={svgPaths.paa51b80} fill="var(--fill-0, white)" id="Vector_2" />
                      <path d={svgPaths.p24f764b0} fill="var(--fill-0, white)" id="Vector_3" />
                      <path d={svgPaths.p336fa080} fill="var(--fill-0, white)" id="Vector_4" />
                    </g>
                  </g>
                  <g id="Vector_5" />
                </g>
              ...
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2_1121" x1="33.5309" x2="33.5309" y1="19.3993" y2="48.6023">
                  <stop stopColor="#7A5DE8" />
                  <stop offset="1" stopColor="#533BAC" />
                </linearGradient>
                <clipPath id="clip0_2_1121">
                  <rect fill="white" height="34" transform="translate(17.0309 17.0006)" width="33" />
                </clipPath>
              </defs>
            </BackgroundImage12>
            <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[12px] text-[rgba(17,17,17,0.5)] tracking-[-0.24px] whitespace-nowrap">롤플레잉</p>
          </div>
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-center min-h-px min-w-px opacity-50 relative">
            <BackgroundImage12>
              <g id="Group 48098815">
                <circle cx="33.4886" cy="33.4886" fill="var(--fill-0, white)" id="Ellipse 644" r="33.4886" />
                <g clipPath="url(#clip0_2_1101)" id="ð í¼ì¹ì§ ìì ì±">
                  <g id="Group">
                    <path d={svgPaths.p2cb3fb40} fill="var(--fill-0, #F6F6F6)" id="Vector" />
                    <path d={svgPaths.p2a8ac000} fill="url(#paint0_linear_2_1101)" id="Vector_2" />
                    <path d={svgPaths.p2fb26900} fill="var(--fill-0, #BEBEDE)" id="Vector_3" />
                  </g>
                  <g id="Vector_4" />
                </g>
              </g>
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2_1101" x1="21.9883" x2="45.6523" y1="36.8435" y2="36.8435">
                  <stop stopColor="#DADADA" />
                  <stop offset="1" stopColor="#DADADA" />
                </linearGradient>
                <clipPath id="clip0_2_1101">
                  <rect fill="white" height="34" transform="translate(16.9879 17.0006)" width="34" />
                </clipPath>
              </defs>
            </BackgroundImage12>
            <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#7a5de8] text-[12px] tracking-[-0.24px] whitespace-nowrap">교재 학습</p>
          </div>
          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-center min-h-px min-w-px relative">
            <BackgroundImage12>
              <g id="Group 48098815">
                <circle cx="33.4886" cy="33.4886" fill="var(--fill-0, white)" id="Ellipse 644" r="33.4886" />
                <g clipPath="url(#clip0_5_2578)" id="ð° ì ë¬¸">
                  <g id="Vector" />
                  <g id="Group">
                    <g id="Group_2">
                      <path d={svgPaths.p33346e00} fill="var(--fill-0, #D0D5DA)" id="Vector_2" />
                      <path d={svgPaths.pe6f8700} fill="var(--fill-0, #AFB7C0)" id="Vector_3" />
                      <path d={svgPaths.p2311be00} fill="var(--fill-0, #8A94A0)" id="Vector_4" />
                    </g>
                    <path d={svgPaths.pd839e00} fill="var(--fill-0, #AFB7C0)" id="Vector_5" />
                    <path d={svgPaths.p135b9900} fill="var(--fill-0, #AFB7C0)" id="Vector_6" />
                    <path d={svgPaths.p1fa2b380} fill="var(--fill-0, #AFB7C0)" id="Vector_7" />
                    <path d={svgPaths.p1725be00} fill="var(--fill-0, #AFB7C0)" id="Vector_8" />
                  </g>
                </g>
              </g>
              <defs>
                <clipPath id="clip0_5_2578">
                  <rect fill="white" height="34" transform="translate(17.0036 16.9772)" width="34" />
                </clipPath>
              </defs>
            </BackgroundImage12>
            <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[12px] text-[rgba(17,17,17,0.6)] tracking-[-0.24px] whitespace-nowrap">기록</p>
          </div>
        </div>
        ...
        <div className="absolute contents left-[calc(75%+44.25px)] top-[498px]" data-name="학습">
          <div className="absolute content-stretch flex flex-col h-[84px] items-center justify-center left-[calc(75%+44.25px)] p-[10px] rounded-[10px] top-[498px] w-[34px]" style={{ backgroundImage: "linear-gradient(rgb(175, 153, 255) 0%, rgb(148, 118, 255) 100%), linear-gradient(rgb(122, 93, 232) 0%, rgb(83, 59, 172) 100%)" }}>
            <p className="font-['Pretendard:Regular',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[12px] text-center text-white w-full">D</p>
          </div>
        </div>
        ...
        <div className="absolute bg-white content-stretch flex flex-col gap-[26px] items-center left-[20px] px-[11px] py-[22px] rounded-[8px] top-[793px] w-[353px]" data-name="Container">
          ...
          <div className="content-stretch flex flex-col gap-[19px] h-[231px] items-center relative shrink-0 w-full">
              ...
              <div className="content-stretch flex gap-[7.995px] h-[20px] items-center relative shrink-0 w-[184px]" data-name="Container">
                <div className="relative shrink-0 size-[14px]" data-name="📰 신문">
                  <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
                    <g clipPath="url(#clip0_5_2610)" id="ð° ì ë¬¸">
                      <g id="Vector" />
                      <g id="Group">
                        <g id="Group_2">
                ...
                <BackgroundImage11 additionalClassNames="h-[20px] w-[162px]">
                  <p className="absolute font-['Pretendard:SemiBold',sans-serif] leading-[20px] left-0 not-italic text-[#80839e] text-[12px] top-[0.71px] tracking-[-0.1504px] whitespace-nowrap">평균보다 2배 많이 확인한 문장</p>
                </BackgroundImage11>
              </div>
            ...
            <div className="h-[140px] shrink-0 w-[317px]" />
          </div>
      ...
      <div className="absolute h-[1827px] left-0 top-0 w-[393px]" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 393 1827\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(28.178 25.082 -118.83 316.59 259.72 969.77)\\'><stop stop-color=\\'rgba(221,220,255,1)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(255,255,255,1)\\' offset=\\'1\\'/><stop stop-color=\\'rgba(226,221,253,1)\\' offset=\\'1\\'/></radialGradient></defs></svg>'), linear-gradient(90deg, rgba(255, 255, 255, 0.88) 0%, rgba(255, 255, 255, 0.88) 100%)" }} />
      <AiEVectorBackgroundImage additionalClassNames="inset-[36.98%_4.58%_62.06%_93.13%]" />
      <AiEVectorBackgroundImage additionalClassNames="inset-[29.86%_10.43%_69.18%_87.28%]" />
      <div className="absolute content-stretch flex flex-col gap-[31px] items-center left-[18px] top-[269px] w-[361.023px]">
        <div className="content-stretch flex items-center p-[12.5px] relative shrink-0" data-name="check">
          <div className="relative shrink-0 size-[73px]" data-name="number">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 73 73">
              <g id="number">
                <rect fill="url(#paint0_linear_2_1150)" height="73" rx="36.5" width="73" />
                <rect fill="url(#paint1_linear_2_1150)" fillOpacity="0.5" height="73" rx="36.5" width="73" />
                <path d={svgPaths.p3ef4b300} id="Vector 8" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6.63636" />
              </g>
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2_1150" x1="17.0057" x2="96.2273" y1="2.8456e-06" y2="50.1875">
                  <stop stopColor="#4FEF95" />
                  <stop offset="1" stopColor="#00B04D" />
                </linearGradient>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_2_1150" x1="45.2102" x2="11.1989" y1="18.6648" y2="60.5568">
                  <stop stopColor="#4FFF99" />
                  <stop offset="1" stopColor="#FFE93F" />
                </linearGradient>
              </defs>
            </svg>
          </div>
        </div>
        <div className="content-stretch flex flex-col gap-[31px] h-[173.999px] items-center relative shrink-0 w-full">
          <div className="content-stretch flex flex-col gap-[15px] items-center relative shrink-0 w-full">
            <p className="font-['Pretendard:Bold',sans-serif] h-[40px] leading-[33.489px] not-italic relative shrink-0 text-[#7a5de8] text-[32px] text-center w-full">표현 학습 완료</p>
            <div className="h-[47.999px] relative shrink-0 w-full" data-name="p">
              <p className="-translate-x-1/2 absolute font-['Pretendard:SemiBold',sans-serif] leading-[22px] left-[180.97px] not-italic text-[#4a5565] text-[14px] text-center top-[-0.34px] tracking-[-0.3125px] whitespace-nowrap">
                내가 외우고 싶은 문장을
                <br aria-hidden="true" />
                익혔어요!
              </p>
          ...
          <div className="bg-[#9d89ea] content-stretch flex gap-[10px] items-center justify-center p-[10px] relative rounded-[100px] shrink-0 w-[277px]">
            ...
            <p className="font-['Pretendard:SemiBold',sans-serif] leading-[22px] not-italic relative shrink-0 text-[14px] text-center text-white tracking-[-0.3125px] whitespace-nowrap">
              💡 배우고 싶은 문장을 직접
              <br aria-hidden="true" />
              만들고 학습해보세요.
            </p>
      ...
      <div className="absolute inset-[18.6%_18.07%_56.22%_13.99%]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 267 215.088">
          <g id="Group 48098831">
            <path d={svgPaths.p3d9e1640} fill="var(--fill-0, #EDCCF8)" id="Vector" />
            <path d={svgPaths.p14de4540} fill="var(--fill-0, #BDBBFF)" id="Vector_2" />
            <path d={svgPaths.p135ef900} fill="var(--fill-0, #BDBBFF)" id="Vector_3" />
            <path d={svgPaths.p31763e00} fill="var(--fill-0, #BDBBFF)" id="Vector_4" />
            <path d={svgPaths.p2835a700} fill="var(--fill-0, #BDBBFF)" id="Vector_5" />
            <path d={svgPaths.p3fcf2500} fill="var(--fill-0, #FFC84D)" id="Vector_6" />
            <path d={svgPaths.p24737b00} fill="var(--fill-0, #FFC84D)" id="Vector_7" />
            <path d={svgPaths.p15c02400} fill="var(--fill-0, #FFC84D)" id="Vector_8" />
            <path d={svgPaths.p3112a340} fill="var(--fill-0, #EDCCF8)" id="Vector_9" />
            <path d={svgPaths.p39853f00} fill="var(--fill-0, #EDCCF8)" id="Vector_10" />
          </g>
        </svg>
      </div>
      <div className="absolute flex inset-[-8.73%_-28.05%_79.71%_-19.57%] items-center justify-center">
        <div className="flex-none h-[578.918px] rotate-[90.29deg] w-[244.935px]">
          <div className="relative size-full">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 244.934 578.919">
              <g id="Group 48098830">
                <path d={svgPaths.p2752e200} fill="var(--fill-0, #EDCCF8)" id="Vector" />
                <path d={svgPaths.pd939800} fill="var(--fill-0, #EDCCF8)" id="Vector_2" />
                <path d={svgPaths.p17b7d280} fill="var(--fill-0, white)" id="Vector_3" />
                <path d={svgPaths.p219bc700} fill="var(--fill-0, #FFC84D)" id="Vector_4" />
                <path d={svgPaths.p1d20bd80} fill="var(--fill-0, #FFC84D)" id="Vector_5" />
                <path d={svgPaths.p74a5dc0} fill="var(--fill-0, white)" id="Vector_6" />
                <path d={svgPaths.pcdd3000} fill="var(--fill-0, #BDBBFF)" id="Vector_7" />
                <path d={svgPaths.p8620700} fill="var(--fill-0, #96E25F)" id="Vector_8" />
                <path d={svgPaths.p1be59000} fill="var(--fill-0, #96E25F)" id="Vector_9" />
                <path d={svgPaths.p28f1ff00} fill="var(--fill-0, #96E25F)" id="Vector_10" />
                <path d={svgPaths.p186fa180} fill="var(--fill-0, #96E25F)" id="Vector_11" />
                <path d={svgPaths.p2f1f2d00} fill="var(--fill-0, #96E25F)" id="Vector_12" />
                <path d={svgPaths.p34b98800} fill="var(--fill-0, #EDCCF8)" id="Vector_13" />
                <path d={svgPaths.p34258500} fill="var(--fill-0, #EDCCF8)" id="Vector_14" />
                <path d={svgPaths.p3c91e500} fill="var(--fill-0, #EDCCF8)" id="Vector_15" />
                <path d={svgPaths.p27012480} fill="var(--fill-0, #BDBBFF)" id="Vector_16" />
                <path d={svgPaths.p2534b100} fill="var(--fill-0, white)" id="Vector_17" />
              </g>
            </svg>
          </div>
        </div>
      </div>
      <BackgroundImageAndText5 text="완료하기" additionalClassNames="bg-[#7a5de8] left-[calc(62.5%+28.38px)]" />
      <BackgroundImageAndText5 text="한번 더 학습" additionalClassNames="bg-[#cec5ef] left-[calc(25%+1.75px)]" />
    </div>
  );
}
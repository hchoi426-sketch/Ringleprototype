...
import svgPaths from "./svg-6fv8tdq12r";
...
export default function IPhone() {
  return (
    <div className="relative size-full" data-name="iPhone 16 - 53" style={{ backgroundImage: "linear-gradient(90deg, rgb(244, 248, 255) 0%, rgb(244, 248, 255) 100%), linear-gradient(90deg, rgb(252, 252, 255) 0%, rgb(252, 252, 255) 100%)" }}>
      ...
      <div className="-translate-x-1/2 absolute content-stretch flex gap-[8px] items-start left-[calc(50%-0.5px)] top-[697px]">
        <div className="absolute bg-white content-stretch flex gap-[7px] h-[44px] items-center left-0 opacity-30 px-[18px] py-[10px] rounded-[101px] top-[26px] w-[117px]">
        ...
        <div className="absolute left-[122px] size-[96px] top-0">
        ...
        <div className="absolute bg-[#7a5de8] content-stretch flex h-[44px] items-center left-[226px] pl-[18px] pr-[10px] py-[10px] rounded-[101px] top-[26px]">
          <p className="font-['Pretendard:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[-0.3125px] whitespace-nowrap">배웠어요</p>
      ...
      <div className="absolute bg-white content-stretch flex flex-col h-[300px] items-center justify-center left-[20px] rounded-[24px] top-[314px] w-[353px]">
          ...
          <div className="content-stretch flex items-center justify-between relative shrink-0 w-[319px]">
            <div className="relative shrink-0 size-[24px]" data-name="stash:save-ribbon-solid">
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                <g id="stash:save-ribbon-solid" opacity="0.2">

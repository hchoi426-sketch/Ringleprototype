...
import svgPaths from "./svg-i3gg1l2xr3";
...
export default function Ai() {
  return (
    <div className="relative size-full" data-name="AI 학습 - 1단계 / 카드앞면" style={{ backgroundImage: "linear-gradient(90deg, rgb(244, 248, 255) 0%, rgb(244, 248, 255) 100%), linear-gradient(90deg, rgb(252, 252, 255) 0%, rgb(252, 252, 255) 100%)" }}>

...
import svgPaths from "./svg-lrbpdzokay";
type IPhone1645BackgroundImageProps = {
  additionalClassNames?: string;
};

function IPhone1645BackgroundImage({ children, additionalClassNames = "" }: React.PropsWithChildren<IPhone1645BackgroundImageProps>) {
  return (
...
export default function IPhone() {
  return (
    <div className="relative size-full" data-name="iPhone 16 - 45" style={{ backgroundImage: "linear-gradient(90deg, rgb(244, 248, 255) 0%, rgb(244, 248, 255) 100%), linear-gradient(90deg, rgb(252, 252, 255) 0%, rgb(252, 252, 255) 100%)" }}>
      <IPhone1645BackgroundImage additionalClassNames="h-[661px] top-[81px]">
      ...
      </IPhone1645BackgroundImage>
      <IPhone1645BackgroundImage additionalClassNames="h-[587px] top-[264px]">
      ...
      <div className="-translate-x-1/2 absolute content-stretch flex h-[96px] items-center justify-between left-[calc(50%-0.5px)] top-[697px] w-[345px]">
        ...
        <div className="bg-white content-stretch flex gap-[7px] items-center px-[18px] py-[10px] relative rounded-[101px] shrink-0">
        ...
        <div className="bg-[#7a5de8] content-stretch flex h-[44px] items-center pl-[18px] pr-[10px] py-[10px] relative rounded-[101px] shrink-0 w-[117px]">
      ...
      <div className="absolute bg-white content-stretch flex flex-col h-[300px] items-center justify-center left-[20px] rounded-[24px] top-[315px] w-[353px]">
        ...
        <div className="content-stretch flex flex-col gap-[54px] h-[248px] items-center relative shrink-0">
          ...
          <div className="content-stretch flex flex-col gap-[16px] h-[104px] items-center not-italic relative shrink-0 text-center">
            <p className="font-['Pretendard:SemiBold',sans-serif] leading-[39px] relative shrink-0 text-[#7a5de8] text-[24px] tracking-[0.0703px] w-[297px]">What if we test this first?</p>
            <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] relative shrink-0 text-[#999] text-[14px] tracking-[-0.1504px] whitespace-nowrap">이걸 먼저 테스트해보면 어떨까요?</p>
          </div>
        </div>
      </div>
